...
st.write(
    """
    # About This App   
    Are you a Bangladeshi gamer looking to buy a graphics card? Do you wish you had a crystal ball to which you could just tell your budget, and
...
st.write(
    ...
    GPU, or if you are interested in the raw performance only. According to your selections, a Performance Score will be selected. You can find more
    details about performance scores [here](https://github.com/Saminyead/gpu_for_bd_gamers/blob/master/docs/tier_score_simplified.md). 
...
st.write("""
This is my first web application, and as a result may be a bit lacking in user experience. I plan to keep improving it, and adding more features. 
Hopefully, this will help you get the best price-to-performance for your money.
""")